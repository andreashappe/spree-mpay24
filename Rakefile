...
desc 'Generate documentation for the mpay_gateway extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MpayGatewayExtension'
...
desc 'Test the mpay_gateway extension.'
...
namespace :test do
  desc 'Functional test the mpay_gateway extension.'
  ...
  desc 'Unit test the mpay_gateway extension.'
